...
![AWS RDS](../../../../static/img/aws/aws-rds.png)
...
![AWS Elasticsearch Service](../../../../static/img/aws/aws-elasticsearch.png)
...
found [here](https://github.com/datahub-project/datahub/blob/master/metadata-service/factories/src/main/resources/application.yml).
...
![AWS MSK](../../../../static/img/aws/aws-msk.png)
