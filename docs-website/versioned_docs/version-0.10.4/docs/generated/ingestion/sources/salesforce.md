...
| --------------------------------------------------- | ------ | ---------------------------------------------------------------------------- |
| [Data Profiling](http://google.com)                 | ✅     | Only table level profiling is supported via `profiling.enabled` config field |
| [Detect Deleted Entities](http://google.com)        | ❌     | Not supported yet                                                            |
