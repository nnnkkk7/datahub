...
![Find the DAG](../../../../static/img/airflow/find_the_dag.png)

By default, Airflow loads all DAG-s in paused status. Unpause the sample DAG to use it.
![Paused DAG](../../../../static/img/airflow/paused_dag.png)
![Unpaused DAG](../../../../static/img/airflow/unpaused_dag.png)

Then trigger the DAG to run.

![Trigger the DAG](../../../../static/img/airflow/trigger_dag.png)

After the DAG runs successfully, go over to your DataHub instance to see the Pipeline and navigate its lineage.

![DataHub Pipeline View](../../../../static/img/airflow/datahub_pipeline_view.png)

![DataHub Pipeline Entity](../../../../static/img/airflow/datahub_pipeline_entity.png)

![DataHub Task View](../../../../static/img/airflow/datahub_task_view.png)

![DataHub Lineage View](../../../../static/img/airflow/datahub_lineage_view.png)
...
![Find the Task Log](../../../../static/img/airflow/finding_failed_log.png)

![Inspect the Log](../../../../static/img/airflow/connection_error.png)
...
![Pipeline Success](../../../../static/img/airflow/successful_run.png)
