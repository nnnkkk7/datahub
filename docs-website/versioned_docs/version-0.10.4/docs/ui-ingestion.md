...
![](../../../static/img/create-new-ingestion-source-button.png)
...
![](../../../static/img/select-platform-template.png)
...
![](../../../static/img/example-mysql-recipe.png)
...
![](../../../static/img/schedule-ingestion.png)
...
![](../../../static/img/name-ingestion-source.png)
...
![](../../../static/img/custom-ingestion-cli-version.png)
...
4. **Authentication**: If you've enabled [Metadata Service Authentication](authentication/introducing-metadata-service-authentication.md), you'll need to provide a Personal Access Token
   ...
   ![](../../../static/img/ingestion-with-token.png)
...
![](../../../static/img/quickstart-ingestion-config.png)
